            ...
            <Fragment>
                ...
                <div className="card grid-2">
                    <div className="all-center">
                        <img src={avatar_url} alt={`${login}`} title={`${login}`} className="round-img" style={{width:'150px'}} />
                    ...
                    <div>
                        ...
                        <a href={html_url} className="btn btn-dark my-1 text-center" target="_blankl"  rel="nofollow noreffer" >See on Github</a>
                        <ul>
                            <li>
                                {login && <Fragment>
